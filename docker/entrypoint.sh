...
echo "[entry] ENV: DISCORD_TOKEN=$(pretty DISCORD_TOKEN) DISCORD_CLIENT_ID=${DISCORD_CLIENT_ID:-<unset>} YT_COOKIE=$(pretty YT_COOKIE) SPOTIFY_CLIENT_ID=${SPOTIFY_CLIENT_ID:-<unset>} SPOTIFY_CLIENT_SECRET=$(pretty SPOTIFY_CLIENT_SECRET)"
